...
//
//		v.addElement("DataScience");// synchronized way
//		v.addElement("Django");
...
// methods like boolean push(), boolean peek(), boolean push(object o), which
// defines
// its properties.
...
//
//		}
//		System.out.println("**********************"); // Access element from the top of the stack
//
//		String top = stack.peek();
//		System.out.println("Element at top: " + top); // prints stack
//
//	}
//}
// ===========================
public class Collection_03_Vector_stack {
	public static void main(String args[]) {
		...
		System.out.println("**********************");
		int location = stack.search("Scala");
