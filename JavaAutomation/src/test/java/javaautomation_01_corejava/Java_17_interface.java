...
//
// Java_17_interface obj = new Java_17_interface(); // Creating an object of the
// // implementing class
...
// In Java, interface methods are by default public and abstract even if you
// don't explicitly specify these modifiers.
// Therefore, you don't need to declare the public access modifier explicitly
