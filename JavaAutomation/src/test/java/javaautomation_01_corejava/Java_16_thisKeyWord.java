...
class Person {
	...
	public Person(String name, int age, int sal) {
		...
		// 'name' refers to the
		// parameter
		this.age = age; // 'this.age' refers to the instance variable 'age', 'age'
		// refers to the
		// parameter
		this.sal = sal;
	}
	...
	public void printDetails() {
		System.out.println("Name: " + this.name); // Using 'this' to access instance
		// variable 'name'
		System.out.println("Age: " + this.age); // Using 'this' to access instance
		// variable 'age'
		System.out.println("Sal: " + this.sal); // Using 'this' to access instance
		// variable 'age'
	...
	public Person() {
		...
		System.out.println("Sal: "); // Using 'this' to access instance variable
		// 'age'
