...
//	}
//
//	// <access modifier>< non accessmodifier> returnType methodName(){Method
//	// body}
//
...
//	}
//
//	public static void printName(String subName) {
//
...
//public class Java_07_Functions {
//	public static void main(String[] args) {
//		studentDivision(1000);
//	}
//
//	public static void studentDivision(int marks) {
//		if (marks >= 600) {// (1000>=600)
//			System.out.println("Division: A1");
//		} else if (marks < 500) {
//			System.out.println("Division:A2");
//		} else {
...
// Parameters are same
// Difference in the return type, access modifier only will not make a function
// overloaded
// ---------------------------
public class Java_07_Functions {
	public static void main(String[] args) {
