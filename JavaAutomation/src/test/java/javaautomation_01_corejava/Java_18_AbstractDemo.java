...
base for subclasses.
b. It can contain both regular methods with implementations and abstract methods without implementations.
c. An abstract class is declared using the "abstract" keyword.
 * 
 */
...
//		System.out.println("SBI house loan Rate of Interest is: " + b.gethouseloanrate() + " %");
//
//		b = new PNB123();
//		System.out.println("Rate of Interest is: " + b.getRateOfInterest() + " %");
//		System.out.println("PNB houseloan rate of Interest is: " + b.gethouseloanrate() + " %");
//
//	}
//}

// ==============================
//In Java, for methods within an abstract class, if you do not explicitly define an access modifier, it defaults to package-private visibility. 
//Package-private means the method is accessible within the same package but not outside of it.
public abstract class Java_18_AbstractDemo {
	// Default visibility: package-private
	abstract void myAbstractMethod(); // Package-private by default

	// Public visibility
	public abstract void anotherAbstractMethod();

	// Protected visibility
	protected abstract void thirdAbstractMethod();
}
