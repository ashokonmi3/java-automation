 ...
 * 
 * type<int/float/String> nameOfArray [] 
 * int array1 [] 
 * String s [] /* int
...
//	public static void main(String[] args) {
//		int array1[] = { 188, 288, 389, 49, 995 };
//		for (int i = 0; i < array1.length; i++) { // (initialization; condition;
//			// increment)
...
//		int array1[] = { 1, 2, 3, 4, 5 };
//		int array2[] = array1;
//		array1[0] = 1000;// This will change the value for array2 as well
...
//			System.out.println(array2[i]);
//		}
//		System.out.println("array2 == array1 " + (array2 == array1));
//
//	}
//}
// ==============/
...
//		System.arraycopy(array1, 2, array2, 2, 3); // (source, index in source,
//		// destination, index in destination, length)
//		for (int i = 0; i < array2.length; i++) {
//			System.out.println(array2[i]);
//		}
//	}
...
//		System.out.println("***********Enhanced loop on array***********");
//
//		for (char x : vowels) {
...
// ======================================
// special char < no < capital letter < small letter
//class Java_06_Arrays {
//	public static void main(String[] args) {
