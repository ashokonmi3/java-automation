...
// ArrayList is a data structure in programming that's part of the Java language
// (and similar concepts exist in other languages as well).
// It's a dynamic array that can resize itself when elements are added or
// removed.
//
// In Java, ArrayLists are part of the java.util package and provide more
// functionality compared to regular arrays. They allow you to:
//
// Dynamically Resize: Unlike arrays, ArrayLists can grow or shrink in size.
// Store Objects: They can store objects of any type, including primitive types
// (with the use of wrapper classes).
// Easy Manipulation: Elements can be easily added, removed, or accessed at any
// specified position.
// =====================
...
//		list.add("scala");
//		list.add("c++");
//		System.out.println("Traversing list through List Iterator of size: " + list.size());
...
//		System.out.println("this are just to show the iterator");
//		System.out.println("*********************");
//		System.out.println("######################");
//
//		str = list1.previous();
...
//
//		al.remove("C");
//		System.out.println("After invoking remove(C) method: " + al);
//
...
//		System.out.println("indexOf(20):  " + index);
//		System.out.println("#################");
//
//		System.out.println("Enahnced loop ");
//
//		for (int i : myNumbers) {
